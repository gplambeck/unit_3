...
'''plambeck_PyGame - A game in which 2 players each move their sprite around a
room competing to collect a coin that randomly appears in the room. The player
with the most coins collected wins the game.'''

import random, pygame

pygame.init()

# A function that animates the sprite.
...
# Bottom secret passage function.
def downClear(x, y):
    canMove = True
...
# Function that handles sprite leaving the room.
...
# Function that handles sprites bumping into each other.
def playersTouching():
...
# Function that handles sprite collecting the coin.
def touchingCoin(x, y):
    return -32 < x - coinPos[0] < 20 and -40 < y - coinPos[1] < 20

# Function to randomly position a coin in the room.
def randomPosition():
...
# Variables for positions and points.
...
# Load images
# Images from https://www.wiley.com/en-us/Adventures+in+Python-p-9781118951798
...
# Load music & sound
# Music & sound from
# https://www.wiley.com/en-us/Adventures+in+Python-p-9781118951798
